...
class InlineValueFeature extends client_1.TextDocumentFeature {
    ...
    registerLanguageProvider(options) {
        ...
        return [vscode_1.languages.registerInlineValuesProvider(this._client.protocol2CodeConverter.asDocumentSelector(selector), provider), { provider: provider, onDidChangeInlineValues: eventEmitter }];
    }
}
