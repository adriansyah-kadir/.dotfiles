...
class InlayHintsFeature extends client_1.TextDocumentFeature {
    constructor(client) {
    ...
    registerLanguageProvider(options) {
        ...
        provider.resolveInlayHint = options.resolveProvider === true
            ...
            : undefined;
        return [vscode_1.languages.registerInlayHintsProvider(this._client.protocol2CodeConverter.asDocumentSelector(selector), provider), { provider: provider, onDidChangeInlayHints: eventEmitter }];
    }
}
