...
command OpenSnippet :CocCommand snippets.openSnippetFiles
command EditSnippet :CocCommand snippets.editSnippets
...
nnoremap gf <cmd>call OpenFile()<cr>
nmap <C-space> <cmd>NERDTreeToggle<cr>
nmap dq <esc>F<space>vt>
command Sovim :so ~/.config/nvim/init.vim
command Format :call FormatNow()
